...
<template>
    ...
    <div class="absolute rounded-md px-3 py-1 h-96 w-96 bg-purple-500 right-2 top-2">
        ...
        <div v-else class="flex flex-col h-full">
                ...
                <div class="py-2" v-for="producto in carrito">
                    <div class="flex flex-col items-center">
                        <div class="flex items-center justify-center text-center">
                            ...
                            <span class="mx-1 px-1 text-2xl text-red-500  bg-white rounded-md cursor-pointer"> - </span>
                            <span class="mx-1 text-xl"> {{ producto.cantidad }} </span>
                            <span class="mx-1 px-1 text-xl text-green-500 bg-white rounded-md cursor-pointer"> + </span>
                        </div>
                    <div class="mt-2">
            ...
            <button class="bg-white text-purple-800 p-2 rounded-md my-2 self-center mt-auto"> PAGAR </button>
        </div>
    </div>
</div>
